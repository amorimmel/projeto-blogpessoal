...
public class SwaggerConfig {
	...
	.title("Blog Pessoal")
	.description("Primeira API Spring - Blog Pessoal")
	.version("1.0.0")
	.license("Apache License Version 2.0")
	.licenseUrl("https://github.com/amorimmel")
	.contact(contact())
	.build();
	}
	private static Contact contact() {
	return new Contact("Melissa Amorim",
	"https://github.com/amorimmel",
	"melissa18.mo@gmail.com");
	}
	...
	.description("Não foi encontrado! :( ").build());
